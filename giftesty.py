...
cat_gif = tk.PhotoImage(file="cat.gif")
cat_label = tk.Label(root, image=cat_gif)
cat_label.place(relx=1.00, rely=1.00, anchor="se")  # Ustaw pozycję w prawym dolnym rogu
